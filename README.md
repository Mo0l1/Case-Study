...
- All monthly trip tables (July 2025 – June 2026) were loaded into BigQuery and merged into a single table (~5.93M rows). See [01.merge_tables.sql](sql/01.merge_tables.sql)
