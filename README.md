...
A Chi-Square test of independence confirmed a statistically significant association between `member_casual` and `day_of_week` (χ² = 156,443.80, p < 0.001, df = 6), with a **moderate** effect size (Cramér's V = 0.163), supporting a clear commuter (member) vs. leisure (casual) usage pattern.
